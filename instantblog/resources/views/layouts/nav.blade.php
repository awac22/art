<nav id="mainnav" class="navbar navbar-expand-md navbar-{{ $theme }} bg-nav">    
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
                <a class="nav-link me-3 d-none d-md-block {{ Request::is('/') ? 'active' : '' }}" href="{{ url('/') }}" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Art Home"><i class="icon-house-door nav-icon"></i></a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link me-3 dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<img class="avatar-xs img-fluid rounded-circle" id="profile_pic" src=""/>    
                    @else
                     <img class="avatar-xs img-fluid rounded-circle" id="profile_pic" src=""/>    
				 @endif
                    {{ auth()->user()->name }}
