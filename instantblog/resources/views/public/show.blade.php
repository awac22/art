    ...
    <div class="row">
        <div class="col-md-8">
			...
			if (strpos($url, $key) == false) {
				$url=url('/uploads/' . $post->post_media);
			}
           else {
             $url=$post->post_media;
            }
        @endphp
                ...
                @elseif(!empty($post->post_media))
                    <img class="card-img-top img-fluid border-two" src="{{ $url }}" alt="{{ $post->media_alt }}">
                @endif
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    @else
                    <p class="text-center"><a class="btn btn-sm btn-arrow border-one mt-2" role="button" href="https://anywhereanycity.com/home/login" > <span class="m-2"><i class="icon-chat-dots"></i> @lang('messages.comments.logincomment') </span></a></p>
                    @endif
