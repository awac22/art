<div class="row mb-4">
    <div class="col-lg-6">
        <div class="profile-card">
               ...
               <img height="200px" width="200px" class="header-img-top"  id="profile_pic1" src=""  />   
			
                @else
                 <img style="border-radius:5px" height="200px" width="200px" class="header-img-top"  id="profile_pic1" src=""  />   
                @endif
        </div>
